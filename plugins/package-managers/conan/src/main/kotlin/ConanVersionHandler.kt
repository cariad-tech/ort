...
internal interface ConanVersionHandler {
    ...
    /**
     * Get the Conan data file for a package with the given [name] and [version] and optionally [user] and [channel]
     * from the [conanStorageDir].
     *
     * This file can also be resolved against a specific [recipeFolder] in case of Conan 2.
     */
    fun getConanDataFile(name: String, version: String, user: String, channel: String, conanStorageDir: File, recipeFolder: String? = null): File?
